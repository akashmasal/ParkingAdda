                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="top-number">
                            <p><i class="bi bi-telephone"></i> <a class="dialer" href="tel:18008890180">+18008890180</a> &nbsp; &nbsp; <i class="bi bi-envelope"></i> &nbsp;<a class="mailerto" href="mailto: info@parkingadda.com">info@parkingadda.com</a></p>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="social">
                            <ul class="social-share">
                                <li><a href="https://www.facebook.com/ParkingAdda"><i class="bi bi-facebook"></i></a></li>
                                <li><a href="https://www.instagram.com/parkingadda"><i class="bi bi-instagram"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
